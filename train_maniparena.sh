...
vla_config_path="maniparena.yaml"
exp_name="a1_maniparena"
...
BATCH_PER_GPU=4   # Batch size per GPU, can be overridden with --batch_size
STATE_MASK_PROB="0.1"   # State mask probability, can be overridden with --state_mask_prob
